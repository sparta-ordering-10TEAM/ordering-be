...
public class RegionService {
    ...
    private static final Set<Role> ADMIN_ROLES = Set.of(Role.MANAGER, Role.MASTER);
    ...
    public RegionResponse createRegion(RegionCreateRequest request, UUID userId) {
        ...
        if (parent != null && parent.getDepth() >= Region.MAX_DEPTH) {
            throw new ApiException(GeneralResponseCode.REGION_DEPTH_EXCEEDED);
        }
